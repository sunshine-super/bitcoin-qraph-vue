      ...
      <div class="col-12  align-items-center">
        <div class="row chart-bar">
          <div class="chart-type">
            ...
            <button class="btn btn-primary btn-sm" :class="[{ 'active': chartType === 'lc' }]" @click="toLineChart">Line
              Chart</button>
          </div>
        </div>
      </div>
...
const proxyUrl = 'https://proxy.mysoftnotes.com/proxy.php?url=';
...
export default {
  ...
  data() {
    return {
      ...
      apiKey: '66897c15-3b80-44fb-aacb-adb6a31353b1'
    }
  },
  mounted() {
    this.fetchChartData();
  ...
  methods: {
    ...
    fetchChartData(isUpdate = false) {
      ...
      const apiurl = encodeURIComponent(`https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?CMC_PRO_API_KEY=${this.apiKey}&start=1&limit=5&convert=USD`);
      ...
      axios.defaults.headers.common['CMC_PRO_API_KEY'] = '66897c15-3b80-44fb-aacb-adb6a31353b1';
